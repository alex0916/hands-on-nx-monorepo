...
import { POSTS } from 'apps/gql-nexus-service/src/test/operations';
import { postsFixture, commentsFixture, usersFixture } from 'apps/gql-nexus-service/src/test/fixtures';
